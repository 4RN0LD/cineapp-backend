...
public class PeliculaController {
	...
	public ResponseEntity<Object> registrar(@Valid @RequestBody Pelicula obj) {
		...
		return new ResponseEntity<Object>(pel, HttpStatus.CREATED);
	}*/
	...
	@PutMapping
	public ResponseEntity<Object> modificar(@Valid @RequestBody Pelicula obj) {
		Pelicula pel = service.modificar(obj);
		return new ResponseEntity<Object>(pel, HttpStatus.OK);
	}
